...
//        tableView.reloadData()
    ...
    override func viewDidLoad() {
        ...
        let userName = "Max"
        let featchReqets: NSFetchRequest<User> = User.fetchRequest()
        featchReqets.predicate = NSPredicate(format: "name == %@", userName)
        
        do {
            let results = try context.fetch(featchReqets)
            if results.isEmpty{
